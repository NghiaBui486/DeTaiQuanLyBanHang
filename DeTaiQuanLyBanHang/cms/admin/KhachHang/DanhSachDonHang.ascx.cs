    ...
    public partial class DanhSachDonHang : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                for (int i = 0; i < tbDONHANG.Rows.Count; i++)
                {
                    ...
                    <tr>
                        ...
                        <td style='background-color:#ffffff; text-align:center; width:30px; height:30px;'>
                            <a href = '/Admin.aspx?modul=KhachHang&modul1=XemDSDonHang&MaDonHang=" + tbDONHANG.Rows[i]["MADONHANG"] + @"'><img src='../../../../pic/detail.png' title='Detail'/></a>
                        </td>
                    </tr>";
                }
            }
            else if (Request.QueryString["MaKH"] == null)
            {
                ...
                LbReturn.Text = "<a href='/Admin.aspx?modul=KhachHang&modul1=XemDSDonHang' style='text-align:center; color:#000000'>Quay lại</a>";
            }
            else
            {
