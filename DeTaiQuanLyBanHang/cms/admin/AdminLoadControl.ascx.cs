            ...
            switch (modul)
            {
                ...
                case "KhachHang":
                    ...
                    case "TinTuc":
                        ...
                        break;
                    case "LienHe":
                        PlaceHolderLoadControlAdmin.Controls.Add(LoadControl("LienHe/LienHeLoadControl.ascx"));
                        break;
                case "NhaCungCap":
                    PlaceHolderLoadControlAdmin.Controls.Add(LoadControl("NhaCungCap/NhaCungCap.ascx"));
                    break;
                case "GioiThieu":
                    PlaceHolderLoadControlAdmin.Controls.Add(LoadControl("GioiThieu/GioiThieu.ascx"));
                    break;
                case "TaiKhoan":
